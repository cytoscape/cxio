...
public class NetworkAttributesFragmentReader extends AbstractFragmentReader {
        ...
        while (t != JsonToken.END_ARRAY) {
            if (t == JsonToken.START_OBJECT) {
                ...
                if ((_time_stamp == null) && ParserUtils.isTimeStamp(o)) {
                    ...
                    na_aspects.add(new NetworkAttributesElement(ParserUtils.getAsStringListRequired(o, AbstractAttributesElement.ATTR_PROPERTY_OF), ParserUtils
