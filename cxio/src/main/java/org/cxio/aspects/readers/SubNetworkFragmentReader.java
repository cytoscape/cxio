...
public class SubNetworkFragmentReader extends AbstractFragmentReader {
        ...
        while (t != JsonToken.END_ARRAY) {
            if (t == JsonToken.START_OBJECT) {
                ...
                if ((_time_stamp == null) && ParserUtils.isTimeStamp(o)) {
                    ...
                    final SubNetworkElement e = new SubNetworkElement(ParserUtils.getTextValueRequired(o, SubNetworkElement.SUBNET_ID), ParserUtils.getTextValueRequired(o,
