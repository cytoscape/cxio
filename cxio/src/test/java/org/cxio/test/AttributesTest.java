...
public class AttributesTest {
    ...
    @Test
    public void test() {
        final HiddenAttributesElement a = HiddenAttributesElement.createInstanceWithSingleValue(0, "name", null, ATTRIBUTE_DATA_TYPE.STRING);

        assertTrue(a.isSingleValue() == true);
        assertTrue(a.getValue() == null);
        assertTrue(CxioUtil.getAttributeValuesAsString(a).equals("null"));

        final HiddenAttributesElement aa = HiddenAttributesElement.createInstanceWithSingleValue(0, "name", "null", ATTRIBUTE_DATA_TYPE.STRING);

        assertTrue(aa.isSingleValue() == true);
        assertTrue(aa.getValue() == null);
        assertTrue(CxioUtil.getAttributeValuesAsString(aa).equals("null"));

        final HiddenAttributesElement aaa = HiddenAttributesElement.createInstanceWithSingleValue(0, "name", "\"null\"", ATTRIBUTE_DATA_TYPE.STRING);
        ...
        final String b_s = "\"v\"";
        final HiddenAttributesElement b = HiddenAttributesElement.createInstanceWithSingleValue(0, "name", b_s, ATTRIBUTE_DATA_TYPE.STRING);

        assertTrue(b.isSingleValue() == true);
        assertTrue(b.getValue().equals("v"));
        assertTrue(CxioUtil.getAttributeValuesAsString(b).equals(b_s));

        final HiddenAttributesElement bb = HiddenAttributesElement.createInstanceWithSingleValue(0, "name", "\"true\"", ATTRIBUTE_DATA_TYPE.BOOLEAN);
        ...
        final HiddenAttributesElement c = HiddenAttributesElement.createInstanceWithMultipleValues(0, "name", null, ATTRIBUTE_DATA_TYPE.LIST_OF_STRING);
        assertTrue(c.isSingleValue() == false);
        assertTrue(c.getValues() == null);
        assertTrue(CxioUtil.getAttributeValuesAsString(c).equals("null"));

        final HiddenAttributesElement d = HiddenAttributesElement.createInstanceWithMultipleValues(0, "name", "[]", ATTRIBUTE_DATA_TYPE.LIST_OF_STRING);
        assertTrue(d.isSingleValue() == false);
        assertTrue(d.getValues() != null);
        assertTrue(CxioUtil.getAttributeValuesAsString(d).equals("[]"));

        final String e_s = "[\"a\"]";
        final HiddenAttributesElement e = HiddenAttributesElement.createInstanceWithMultipleValues(0, "name", e_s, ATTRIBUTE_DATA_TYPE.LIST_OF_STRING);
        ...
        final HiddenAttributesElement f = HiddenAttributesElement.createInstanceWithMultipleValues(0, "name", f_s, ATTRIBUTE_DATA_TYPE.LIST_OF_STRING);
        ...
        final HiddenAttributesElement g = HiddenAttributesElement.createInstanceWithMultipleValues(0, "name", f_s2, ATTRIBUTE_DATA_TYPE.LIST_OF_STRING);
        ...
        final HiddenAttributesElement h = HiddenAttributesElement.createInstanceWithMultipleValues(0, "name", g_s, ATTRIBUTE_DATA_TYPE.LIST_OF_DOUBLE);
