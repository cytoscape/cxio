...
public class OpaqueElementRoundTripTest {
    ...
    public void test() throws IOException {
        ...
        // final OpaqueElement unknown_element = new OpaqueElement("unknown",
        // unknown);
        //
        // // ---------
        //
        ...
        //
        // final OpaqueElement anonymous_element = new
        // OpaqueElement("anonymous", anonymous);
        //
        // // ---------
        //
        ...
        //
        // final OpaqueElement anonymous_too_1_elem = new
        // OpaqueElement("anonymous too", anonymous_too_1);
        // final OpaqueElement anonymous_too_2_elem = new
        // OpaqueElement("anonymous too", anonymous_too_2);
        // final OpaqueElement anonymous_too_3_elem = new
        // OpaqueElement("anonymous too", anonymous_too_3);
        //
        // final List<OpaqueElement> anonymous_too_elements = new
        // ArrayList<OpaqueElement>();
        ...
        // single.put("4", "4");
        // single.put("5", "5");
        // final OpaqueElement single_element = new OpaqueElement("single",
        // single);
        //
        // // ---------
        //
        ...
        // single2.put("1", "1");
        // single2.put("2", "2");
        // final OpaqueElement single_element2 = new OpaqueElement("single2",
        // single2);
        //
        // // ---------
        //
        // final List<AspectElement> edges_elements = new
        ...
        // final CxReader r = CxReader.createInstance(cx_json_str, true, true,
        // readers);
        //
        // final SortedMap<String, List<AspectElement>> res =
        // CxReader.parseAsMap(r);
        //
        ...
        //
        // final List<AspectElement> res_anonymous_too =
        // res.get("anonymous too");
