...
public class Cookbook {
    ...
    public static void main(final String[] args) throws IOException, NoSuchAlgorithmException {
        ...
        edges_elements.add(new EdgesElement(0, 0, 2));
    ...
    private final static void customElementWriterAndReader() throws IOException {
        ...
        final List<AspectElement> cartesian_elements = new ArrayList<AspectElement>();
        cartesian_elements.add(new CartesianLayoutElement(0, 12.0, 21.0, 1.0));
        cartesian_elements.add(new CartesianLayoutElement(0, 42.0, 23.0, 2.0));
        cartesian_elements.add(new CartesianLayoutElement(0, 34.0, 23.0, 3.0));
