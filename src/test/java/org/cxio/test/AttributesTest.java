...
public class AttributesTest {
	...
	public void test() throws IOException {
		// Verify that parsing of elements and lists returns correct results

		// Verify that parseStringtoStringList returns a valid string list
		...
		final List<String> a4 = DatamodelsUtil.parseStringToStringList("[\"a\",\"b\\\"b\"]",
		...
		assertTrue(a5.get(1).equals("b\"b"));

		// Verify that an attribute class (e.g., HiddenAttributesElement) can
		// parse and return a single value object

		final HiddenAttributesElement a = HiddenAttributesElement.createInstanceWithSingleValue(0L, "name", null,
				ATTRIBUTE_DATA_TYPE.STRING);
		...
		final HiddenAttributesElement aa = HiddenAttributesElement.createInstanceWithSingleValue(0L, "name", "null",
				ATTRIBUTE_DATA_TYPE.STRING);
		...
		final HiddenAttributesElement aaa = HiddenAttributesElement.createInstanceWithSingleValue(0L, "name",
				"\"null\"", ATTRIBUTE_DATA_TYPE.STRING);
		...
		final String b_s = "\"v\"";
		final HiddenAttributesElement b = HiddenAttributesElement.createInstanceWithSingleValue(0L, "name", b_s,
				ATTRIBUTE_DATA_TYPE.STRING);
		...
		final HiddenAttributesElement bb = HiddenAttributesElement.createInstanceWithSingleValue(0L, "name", "\"true\"",
		...
		// Verify that an attribute class (e.g., HiddenAttributesElement) can
		// parse and return a multiple value object

		final HiddenAttributesElement c = HiddenAttributesElement.createInstanceWithMultipleValues(0L, "name", null,
		...
		final HiddenAttributesElement d = HiddenAttributesElement.createInstanceWithMultipleValues(0L, "name", "[]",
				ATTRIBUTE_DATA_TYPE.LIST_OF_STRING);
		...
		final String e_s = "[\"a\"]";
		final HiddenAttributesElement e = HiddenAttributesElement.createInstanceWithMultipleValues(0L, "name", e_s,
				ATTRIBUTE_DATA_TYPE.LIST_OF_STRING);
		...
		final HiddenAttributesElement f = HiddenAttributesElement.createInstanceWithMultipleValues(0L, "name", f_s,
				ATTRIBUTE_DATA_TYPE.LIST_OF_STRING);
		...
		final HiddenAttributesElement g = HiddenAttributesElement.createInstanceWithMultipleValues(0L, "name", f_s2,
				ATTRIBUTE_DATA_TYPE.LIST_OF_STRING);
		...
		final HiddenAttributesElement h = HiddenAttributesElement.createInstanceWithMultipleValues(0L, "name", g_s,
				ATTRIBUTE_DATA_TYPE.LIST_OF_DOUBLE);
		assertTrue(h.isSingleValue() == false);
		assertTrue(h.getValues() != null);
		assertTrue(CxioUtil.getAttributeValuesAsString(h).equals(g_s));

		final String h_s = "[\"\"]";
		final HiddenAttributesElement hh = HiddenAttributesElement.createInstanceWithMultipleValues(0L, "name", h_s,
				ATTRIBUTE_DATA_TYPE.LIST_OF_STRING);
		assertTrue(f.isSingleValue() == false);
		assertTrue(f.getValues() != null);
		...
		final HiddenAttributesElement hi = HiddenAttributesElement.createInstanceWithMultipleValues(0L, "name", i_s,
				ATTRIBUTE_DATA_TYPE.LIST_OF_STRING);
		...
		final HiddenAttributesElement hi2 = HiddenAttributesElement.createInstanceWithMultipleValues(0L, "name", i_s2,
				ATTRIBUTE_DATA_TYPE.LIST_OF_STRING);
		...
		final HiddenAttributesElement hi3 = HiddenAttributesElement.createInstanceWithMultipleValues(0L, "name", i_s3,
				ATTRIBUTE_DATA_TYPE.LIST_OF_STRING);
		...
		final HiddenAttributesElement hn1 = HiddenAttributesElement.createInstanceWithMultipleValues(0L, "name", n1,
				ATTRIBUTE_DATA_TYPE.LIST_OF_STRING);
		...
		final HiddenAttributesElement hn2 = HiddenAttributesElement.createInstanceWithMultipleValues(0L, "name", n2,
				ATTRIBUTE_DATA_TYPE.LIST_OF_STRING);
		...
		final HiddenAttributesElement hn3 = HiddenAttributesElement.createInstanceWithMultipleValues(0L, "name", n3,
				ATTRIBUTE_DATA_TYPE.LIST_OF_STRING);
		...
		final String n4 = "[\"\\\\\"]";
		final HiddenAttributesElement hn4 = HiddenAttributesElement.createInstanceWithMultipleValues(0L, "name", n4,
				ATTRIBUTE_DATA_TYPE.LIST_OF_STRING);
		...
		final String n5 = "[\"\\n\\f\\b\\r\\t\\\\\\\"\"]";
		final HiddenAttributesElement hn5 = HiddenAttributesElement.createInstanceWithMultipleValues(0L, "name", n5,
				ATTRIBUTE_DATA_TYPE.LIST_OF_STRING);
	...
	public void test2() throws IOException {
		// Verify that a list of attribute elements (e.g.,
		// NetworkAttributesElement) can
		// can be written properly as a fragment in a minimalist CX document

		final NetworkAttributesElement a = NetworkAttributesElement.createInstanceWithMultipleValues(148L,
				"__Annotations", "[ \"\" ]", ATTRIBUTE_DATA_TYPE.LIST_OF_STRING);
		...
		w1.end(true, "");
		String s1 = "[" + TestUtil.NUMBER_VERIFICATION
				+ ",{\"networkAttributes\":[{\"s\":148,\"n\":\"__Annotations\",\"v\":[\"\"],\"d\":\"list_of_string\"}]},{\"status\":[{\"error\":\"\",\"success\":true}]}]";
		assertTrue(out1.toString().equals(s1));
	}

	@Test
	public void test3() throws IOException {
		// Verify that a minimal CX document containing an attribute fragment
		// can be parsed

		final String t0 = "[" + TestUtil.NUMBER_VERIFICATION
				+ ",{\"networkAttributes\":[{\"s\":148,\"n\":\"__Annotations\",\"v\":[\"\"],\"d\":\"list_of_string\"}]}]";

		final CxReader p = CxReader.createInstance(t0, CxioUtil.getAllAvailableAspectFragmentReaders());
		final SortedMap<String, List<AspectElement>> r0 = CxReader.parseAsMap(p);

		assertTrue("failed to parse " + NetworkAttributesElement.ASPECT_NAME + " aspect",
				r0.containsKey(NetworkAttributesElement.ASPECT_NAME));

		final NetworkAttributesElement e = (NetworkAttributesElement) r0.get(NetworkAttributesElement.ASPECT_NAME)
				.get(0);
	...
	private final void test_file(final String cx_file) throws IOException {
		...
		for (final AspectElement e : na) {
			...
			if (a.isSingleValue()) {
				final HiddenAttributesElement aa = HiddenAttributesElement.createInstanceWithSingleValue(0L, "name",
						v_str, a.getDataType());
				...
				final HiddenAttributesElement aa = HiddenAttributesElement.createInstanceWithMultipleValues(0L, "name",
						v_str, a.getDataType());
				assertTrue(v_str.equals(CxioUtil.getAttributeValuesAsString(aa)));
			}
		}
