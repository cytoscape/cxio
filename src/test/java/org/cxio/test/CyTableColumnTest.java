...
public class CyTableColumnTest {
    ...
    @Test
    public void test1() {
        CyTableColumnElement e0 = new CyTableColumnElement(12L, "weight", ATTRIBUTE_DATA_TYPE.DOUBLE);
    ...
    public void test2() throws IOException {
        CyTableColumnElement e0 = new CyTableColumnElement(0L, "weight", ATTRIBUTE_DATA_TYPE.DOUBLE);
        CyTableColumnElement e1 = new CyTableColumnElement(1L, "exp", ATTRIBUTE_DATA_TYPE.LIST_OF_DOUBLE);
        CyTableColumnElement e2 = new CyTableColumnElement(2L, "name", ATTRIBUTE_DATA_TYPE.STRING);
        CyTableColumnElement e3 = new CyTableColumnElement( "all name", ATTRIBUTE_DATA_TYPE.STRING);
