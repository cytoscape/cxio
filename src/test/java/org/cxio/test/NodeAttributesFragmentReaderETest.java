	...
	public void test() throws IOException {
		...
		try {
			final String multiplePO = "[" + TestUtil.NUMBER_VERIFICATION
					+ ",{\"nodeAttributes\":[{\"po\":\"0\",\"n\":\"name1\",\"v\":\"value\"}]},"
		...
		// Verify other node attribute behaviors
		final String t0 = "[" + TestUtil.NUMBER_VERIFICATION
				+ ",{\"nodeAttributes\":[{\"po\":\"0\",\"n\":\"name1\",\"v\":\"value\"}]},"
				+ "{\"nodeAttributes\":[{\"po\":\"1\",\"n\":\"name2\",\"v\":\"12\",\"d\":\"integer\"}]},"
				+ "{\"nodeAttributes\":[{\"po\":\"2\",\"n\":\"name3\",\"v\":\"true\",\"d\":\"boolean\"}]},"
				+ "{\"nodeAttributes\":[{\"po\":\"3\",\"n\":\"name4\",\"v\":[\"1\",\"2\"],\"d\":\"list_of_short\",\"s\":\"1\"}]}"
				+ "]";
		...
		assertTrue("failed to parse " + NodeAttributesElement.ASPECT_NAME + " aspect",
				r0.containsKey(NodeAttributesElement.ASPECT_NAME));
		assertFalse("failed to parse " + NodeAttributesElement.ASPECT_NAME + " aspect",
				r0.get(NodeAttributesElement.ASPECT_NAME).isEmpty());
		assertTrue("failed to get expected number of " + NodeAttributesElement.ASPECT_NAME + " aspects",
				r0.get(NodeAttributesElement.ASPECT_NAME).size() == 4);
		...
		assertTrue(a2.getPropertyOf().size() == 1);
		assertTrue(a2.getPropertyOf().contains(2L));
		...
		assertTrue(a3.getPropertyOf().size() == 1);
