...
public class UTF8Test {
    ...
    public void testUTF8RT1() throws IOException {
        final String t0 = "[" + TestUtil.NUMBER_VERIFICATION
                + ",{\"edgeAttributes\":[{\"po\":0,\"n\":\"한글hangul\",\"v\":\"value\"},"
                + "{\"po\":1,\"n\":\"漢字kanjiひらがなカタカナ\",\"v\":\"12\",\"d\":\"integer\"},"
                + "{\"po\":2,\"n\":\"ราชอาณาจักรไทย\",\"v\":\"true\",\"d\":\"boolean\"},"
                + "{\"s\":1234,\"po\":3,\"n\":\"繁體字\",\"v\":[\"1\",\"2\"],\"d\":\"list_of_short\"}]},{\"status\":[{\"error\":\"\",\"success\":true}]}]";
